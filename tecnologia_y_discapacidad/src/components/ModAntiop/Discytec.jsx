    ...
    return (
        <>
            ...
            <div className='contenedor-tecantiop'>
                ...
                <h3>2. IDENTIFICAR NUESTRAS HABILIDADES</h3>
                <p>
                ...
                <p>
                    El modelo de habilidades antiopresivas, idealmente nos da pistas para hacernos las preguntas correctas a la hora de que estamos desarrollando la tecnología. Por ejemplo, empezar a notar que nunca antes habíamos pensado en las necesidades de las personas con discapacidad en nuestros productos, o buscando opinión de personas con discpacidad sobre lo que hacemos. 
                </p>
                <p> 
                    Más allá de la habilidad en que estemos el ejercitar la conciencia de las personas con discapcidad en los productos que desarrollamos es algo que es necesario ejercitar constantemente.
                </p>
                <h3>4. ESCUCHAR LO QUE LAS PERSONAS CON DISCAPACIDAD DICEN y HACEN SOBRE TECNOLOGÍA</h3>
                <p>
                    Hay personas con discpacidad que consumen y hacen tencnología, busquemos sus voces e intentemos escuchar verdaderamente de manera receptiva y respetuosa.
                </p>
