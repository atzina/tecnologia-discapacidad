      ...
      <div className="principal-modelo conteiner">
        ...
        <div className="gral-dos conteiner-fluid">
          <section className="pregunta-uno col-12 col-md-12 col-lg-12">
            ...
            <p>
              En términos generales, entendemos la opresión como la tendencia a
              sobrevalorar a ciertos grupos y la desvaloración de otros,
              produciendo ventajas para unos y desventajas para los otros. La
              visión que busca esta propuesta tiene que ver con una mirada
              antiopresiva que pueda ir más allá de la inclusión.
            </p>
          </section>
          <section className="pregunta-dos col-12 col-md-12 col-lg-12 ">
            ...
            <p>
              ...
              existentes. Es decir, se incluye a grupos marginados en ambientes
              que no los valoran, exigiéndoles inconscientemente que ellos se
              las arreglen y se vuelvan como los privilegiados, sin cuestionar
              las normas y las estructuras que perpetuan la desigualdad.
            </p>
          </section>
          ...
          <div className="cuadroInfo card">
            <div className="card-body">
              ...
              <p className="card-text">
                El contenido aquí vertido tiene como base en el libro:
                &quot;Beyond incluson, Beyond Empowerment. A developmental
                Satrategy to Liberate Everyone&quot;, construido en muchos años
                de trabajo práctico y académico de Leticia Nieto. Para mas
                información:
              </p>
              <a
