      ...
      <div className="principal-modelo">
        ...
        <div className="gral-dos">
          ...
          <div className="contenedor-modelo">
            <h3>El Modelo</h3>
            <p>El modelo es una guía para la práctica real que comprende el desarrollo de habilidades antiopresivas que pretenden conducir a alcanzar la igualdad. Reconocer que los grupos son infravalorados mientras otros sobrevalorados y entender cual es nuestra membresia en estos contextos para enfrentar la opresión y vivir pleanemtente. El modelo es profundo y requiere mucho trabajo y práctica, este a penas es un pequeño vistazo a la membresia por discapacidad, para conocer la perspectiva general, si quieres conocer más , haz contacto.</p>
