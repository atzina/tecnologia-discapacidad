...
function Habilidades () {
    ...
    return (
        ...
        <div className='contenedor-hab'>
            ...
            <p>
                La toma de conciencia de nuestra posición en el mundo y nuestras membresías sociales y las de los demás, implica una toma de conciencia, esta toma de conciencia trae consigo la adquisión de nuevas habilidades, en tanto aprendmeos formas más flexibles y efectivas para reconocer y responder a los efectos del sistema de Rango, en nosotros y en las demas personas y así, podemos ayudarnos unos a otros a despertar
            </p>

            <p>
                El modelo considera caminos paralelos pero distintos hacia la toma de conciencia y acción en áreas como miembro de un grupo privilegiado y en áreas como miembro de un grupo marginado. La idea es que puedas construir sobra las habilidades que tengas cualquiera que sean los grupos a los que perteneces. Las habilidades antiopresivas pueden desarrollarse una a la vez. 
            </p>
            ...
            <p>Te invito a darle un vistazo a las habilidades y tratar de indenficarte con algunas de ellas: Elige una opción, respondiendo a Me identifico como:</p>
        </div>
        <div className='links-habilidades'>           
                <a href='/persona-discapacidad'>
                    <span className="badge text-bg-info"> Persona con discapacidad</span>
                </a>

                <a href='/persona-sin-discapacidad'>
                <span className="badge text-bg-info">Persona sin discapacidad</span>
                </a>
        </div>
