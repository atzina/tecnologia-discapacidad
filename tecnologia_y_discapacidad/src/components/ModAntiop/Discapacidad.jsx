  ...
  return (
    <>
      ...
      <div className='contenedor-discapacidad'>
        ...
        <p>
            La discapacidad tiene que ver con el efecto combiandao de la devaluación social además de las dificultades asociadas a la dificualtad en sí. Por ejemplo, no solo la falta de movilidad es lo que limita a las personas, sino un mundo construido exclusivamente para las personas que sin movilidad limitada. Lo opresivo es esta exclusión.
        </p>
