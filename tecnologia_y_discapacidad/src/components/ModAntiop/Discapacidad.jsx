  ...
  return (
    <>
      ...
      <div className='contenedor-discapacidad'>
        <p>
            La sociedad está organizada para excluir y limitar las posibilidades de las personas con discapacidad, incluso las personas con discapacidades no visibles o consideradas &quot;leves&quot;.  La discapacidad, a diferencia de la mayoría de la categorías de Rango, puede cambiar durante toda la vida. La pérdida de capacidad es intrínsecamente parte de la experiencia humana; una enfermedad, lesión o condición médica temporal puede convertir a cualquier persona en parte de un grupo marginado, es decir, infravalorado. La mayoría de las personas formaremos parte del grupo marginado por discapacidad en algún momento de nuestras vidas.
        </p>

        <p>
            Las personas sin discapaciad son parte del un grupo Privilegiado y las personas con alguna discapacidad son miembros del un grupo Marginado.
        </p>

        <p>
            La discapacidad tiene que ver con el efecto combinado de la devaluación social, además de las dificultades asociadas a la discapacidad en sí. Por ejemplo, no solo la falta de movilidad es lo que limita a las personas, sino un mundo construido exclusivamente para las personas que sin movilidad limitada... LO OPRESIVO ES LA EXCLUSIÓN.
        </p>
